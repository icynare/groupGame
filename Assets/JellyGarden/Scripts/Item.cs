...
public class Item : MonoBehaviour
{
    ...
    void SetStrippedExtra(Vector3 dir)
    {
        ...
        if (Math.Abs(dir.x) > Math.Abs(dir.y))
        {
            ...
            Debug.Log(">>>HORIZONTAL_STRIPPED");
        }
        else
        {
            NextType = ItemsTypes.VERTICAL_STRIPPED;
            Debug.Log(">>>VERTICAL_STRIPPED");
